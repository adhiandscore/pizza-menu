        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle color-white text-white" href="#" role="button"
            ...
            foreach ($menu as $row):
                ...
                <div class="col-md-4">
                    <div class="card" style="width: 18rem; margin-bottom: 20px;">
                        <img src="..\json\img\menu\<?= $row["gambar"]; ?>" class="card-img-top" alt="...">
                        <div class="card-body">
